package ScreeningHumanity.SearchServer.global.config;
...
public class SwaggerConfig {
    ...
    private List<Server> servers() {
        ...
        dynamicServer.setUrl("https://screeninghumanity.shop/api/v1/search");
        dynamicServer.setDescription("AWS 배포 Server");
